...
export class AutoMigrationAddSessionTimeEntries1767265559051 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."time_entries_type_enum" AS ENUM('WORK', 'SICK', 'VAB', 'VACATION', 'EXTRA', 'MEETING')`);
        await queryRunner.query(`CREATE TABLE "time_entries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "hours" numeric(5,2) NOT NULL, "type" "public"."time_entries_type_enum" NOT NULL, "comment" text, "userId" uuid NOT NULL, "projectId" uuid, CONSTRAINT "PK_b8bc5f10269ba2fe88708904aa0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sessions" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "refresh_token" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "lastActivityAt" TIMESTAMP, "expires_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e9f62f5dcb8a54b84234c9e7a0" ON "sessions" ("token") `);
        await queryRunner.query(`ALTER TABLE "project_assignments" DROP COLUMN "contributionPercentage"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "project_assignments" ADD "contributionPercentage" integer NOT NULL DEFAULT '0'`);
